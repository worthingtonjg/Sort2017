...
namespace SortDemo
{
    ...
    /// </summary>
    public sealed partial class MainPage : Page, IHandle<ActivateVoiceControlsMessage>
    {
        ...
        public void Handle(ActivateVoiceControlsMessage message)
        {
            XamlRow.Height = new GridLength(150);
            XamlCol.Width = new GridLength(1, GridUnitType.Star);

            EventBus.Instance.PublishOnUIThread(new SayMessage("Hello, I am Sister Jones.  Shall we play a game?"));
        }
